...
```
    ...
    ##  1    172    25 Wednesday    10 activity.615     615           150.
    ##  2    124    18 Thursday     17 activity.1032   1032           442.
    ##  3    320    46 Thursday     17 activity.1039   1039           675.
    ##  4    208    30 Thursday     12 activity.738     738             1 
    ##  5     51     8 Monday       11 activity.680     680           458.
    ##  6    227    33 Tuesday      19 activity.1141   1141            74.
    ##  7    227    33 Tuesday       8 activity.485     485             1 
    ##  8    130    19 Wednesday    20 activity.1211   1211            85.
    ##  9    131    19 Thursday     18 activity.1092   1092           442.
    ## 10     44     7 Monday       13 activity.836     836             1
...
I discovered 18 days: day\_id's 7, 8, 15, 18, 19, 20, 23, 25, 26, 27, 55, 78, 83, 84, 86, 133, 140, 219 where total activity is "1440" meaning there was no activity over the entirety of those days. I suspect the patient was not wearing the accelerometer or accelerometer malfunction, so I excluded these days from figures.
